...
namespace TTKDGP.ProjectManager.Services
{
    ...
    public static class ReminderService
    {
        ...
        {
            // Kỳ này không gửi vào nhóm mà gửi mail riêng cho từng người, đi lối khác hẳn.
            if (kind == ReminderKind.FridayMemberEmails)
            {
                return RunMemberEmails(now, isManual, triggeredBy);
            }
