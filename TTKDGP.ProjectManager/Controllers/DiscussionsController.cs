...
namespace TTKDGP.ProjectManager.Controllers
{
    ...
    public class DiscussionsController : BaseController
    {
        ...
        public ActionResult Index(int? projectId)
        {
            ...
            {
                ErrorLog.Write(ex, HttpContext);

                var fallbackProject = projectId.HasValue && projectId.Value > 0 ? Repository.WorkProjects.Find(projectId.Value) : null;
                var safeVm = new DiscussionHubViewModel
                {
        ...
        public ActionResult Panel()
        {
            ...
            {
                ErrorLog.Write(ex, HttpContext);
                return PartialView("_Panel", new List<DiscussionProjectDto>());
            }
        }
